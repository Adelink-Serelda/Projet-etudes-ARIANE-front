      ...
      <nav className="barre-menu">
        ...
        <div className="barre-menu-item">
          <Link to="/collection" className="liens">
            <img
              src="/img/picto-ariane/icone_collection.svg"
        ...
        <div className="barre-menu-item">
          <Link to="/fil" className="liens">
            <img
              src="/img/logo-ariane/logo_fil_64.svg"
              alt="icône fil d'Ariane"
            />
            <span>Fil</span>
          </Link>
        </div>
        <div className="barre-menu-item">
          <Link to="/suggestions" className="liens">
            <img src="/img/picto-ariane/fire.svg" alt="icône suggestions" />
        ...
        <div className="barre-menu-item">
          <Link to="/recherche" className="liens">
            <img
              src="/img/picto-ariane/search.svg"
              alt="icône loupe recherche"
            />
            <span>Recherche</span>
          </Link>
        </div>
